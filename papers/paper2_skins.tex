...
% NOTE (24 Sep 2026): the solver convergence test was corrected. The
% validation table, fit residuals, intervals and tension costs below must
% be regenerated from skin_grid_fixed_*.csv before submission.
\begin{abstract}
...
twenty sweeps.
% NOTE: all skin numbers in this paper must be regenerated with this test
% (rerun_skin_grid_fixed.py). Individual grid points move by up to ~0.006 fm.
